<template>
  <div id="app">
    ...
    <canvas ref="canvas_sakura" class="canvas-sakura"></canvas>
  </div>
</template>
...
// 樱花类定义
const Sakura = function(x, y, s, r, fn, idx) {
  this.x = x
  this.y = y
  this.s = s
  this.r = r
    ...
    getRandom(option) {
      ...
      switch (option) {
        ...
        case "fnx":
          ...
          ret = function(x) { return x + 0.2 * random - 1.1 }
          break
        case "fny":
          random = 1.2 + Math.random() * 0.7
