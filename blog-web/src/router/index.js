...
const routes = [

    {
        ...
        component: Layout,
        meta: {
            title: "Infinity.log-一个专注于技术分享的博客平台",
            loading: true
        },
        children: [
            {
